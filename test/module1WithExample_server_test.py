...
from module1WithExample.module1WithExampleImpl import module1WithExample
from module1WithExample.module1WithExampleServer import MethodContext
from module1WithExample.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class module1WithExampleTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('module1WithExample'):
        ...
        cls.serviceImpl = module1WithExample(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_module1WithExample_" + str(suffix)
